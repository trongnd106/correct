...
# Hàm tìm vị trí của ký tự trên bàn phím
def findPosition(c):
...
# Hàm tính khoảng cách trên bàn phím
def distanceOnKeyboard(c1, c2):
    x1, y1 = findPosition(c1)
    x2, y2 = findPosition(c2)
    return abs(x1 - x2) + abs(y1 - y2)

# Hàm tính khoảng cách Levenshtein dựa trên bàn phím
...
# Hàm tính khoảng cách Levenshtein mặc định
...
# Hàm để sửa từ từ lỗi trong file đầu vào và lưu kết quả vào file đầu ra
...
process_file("dataTest.txt", "correct.txt")
